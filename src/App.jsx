...
const SummarizerView = () => {
  ...
  const generateQuizData = async () => {
    ...
    try {
       ...
       const prompt = `Berikut adalah ringkasan materi yang baru saja dipelajari:\n\n"""\n${summaryResult}\n"""\n\nBerdasarkan teks materi DI ATAS, buatkan kuis pilihan ganda berjumlah persis 5 soal.\nSyarat Mutlak:\n1. JAWABAN HARUS ADA DI DALAM TEKS. Dilarang keras menanyakan fakta atau informasi di luar teks ringkasan tersebut.\n2. Jika materinya berupa rumus atau perhitungan matematika/fisika, ubah angka-angkanya dari contoh di teks agar user bisa berlatih menghitung.\n3. Uji pemahaman konsep atau logika dari teks tersebut (jangan sekadar copy-paste kalimat mentah-mentah, gunakan parafrase atau studi kasus berdasarkan teks).\n4. Berstandar pendidikan tinggi dan berkualitas.`;
